#rete finale dopo aver confrontato la rete indotta e quella da noi proposta, cercando di semplificare la rete indotta
# valutazione performance e confronto con quello indotto
library(bnlearn)
...
# Performance plot
pdf("our_performance2.pdf", width = 8, height = 8)
